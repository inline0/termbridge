...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DDQvZQYU.mjs");
...
const manifest = { "3754d170b07e5384cb393a7ce01e3317e54e102cb5b75ed0780e1a678ae2d91a": {
  ...
  importer: () => import("./_-xMEdLdyC.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-wYwTSpQJ.mjs").then((n) => n._);
