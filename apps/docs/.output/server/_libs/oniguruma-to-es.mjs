import { J, S, m, A, b, w, K, o, E, Q, C, F, _, P, k, O } from "./oniguruma-parser.mjs";
import { r as recursion } from "./regex-recursion.mjs";
import { p as possessive, a as atomic } from "./regex.mjs";
  ...
  Assertion({ node, parent, key, container, root, remove, replaceWith }, state) {
    ...
    if (kind === "text_segment_boundary") {
      ...
      if (!wordIsAscii && !asciiWordBoundaries) {
        ...
        replaceWith(setParentDeep(parseFragment(negate ? B : b2), parent));
      }
    } else {
