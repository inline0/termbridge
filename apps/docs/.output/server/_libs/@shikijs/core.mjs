import { S as ShikiError$1 } from "./types.mjs";
import { F as FontStyle, I as INITIAL, E as EncodedTokenMetadata, R as Registry$1, T as Theme } from "./vscode-textmate.mjs";
...
export {
  warnDeprecated as A,
  addClassToHast as a,
  applyColorReplacements as b,
  createBundledHighlighter as c,
  createHighlighterCore as d,
  createPositionConverter as e,
  createShikiInternal as f,
  createShikiInternalSync as g,
  flatTokenVariants as h,
  getTokenStyleObject as i,
  hastToHtml as j,
  isNoneTheme as k,
  isPlainLang as l,
  isSpecialLang as m,
  isSpecialTheme as n,
  normalizeGetter as o,
  normalizeTheme as p,
  splitToken as q,
  resolveColorReplacements as r,
  splitLines as s,
  splitTokens as t,
  stringifyTokenStyle as u,
  toArray as v,
  tokenizeAnsiWithTheme as w,
  tokenizeWithTheme as x,
  tokensToHast as y,
  transformerDecorations as z
};
